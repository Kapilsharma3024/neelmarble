      ...
      <AnimatePresence>
        {current && lightboxIndex !== null && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex items-center justify-center bg-luxury-black/95 p-4 backdrop-blur-md"
          ...
          >
            ...
            >
              ...
              <div className="bg-luxury-charcoal p-8 border border-white/10">
